...
package de.upb.cs.swt.delphi.crawler.io.swagger.client.core
...
class ApiInvoker(formats: Formats)(implicit system: ActorSystem) extends UntrustedSslContext with CustomContentTypes {
  ...
  import de.upb.cs.swt.delphi.crawler.io.swagger.client.core.ApiInvoker._
  import de.upb.cs.swt.delphi.crawler.io.swagger.client.core.ParametersMap._
