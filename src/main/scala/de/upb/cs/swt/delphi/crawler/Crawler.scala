...
import de.upb.cs.swt.delphi.crawler.discovery.maven.{MavenDiscoveryProcess, MavenErrorRetryProcess}
...
*/
  ...
  processScheduler ! ProcessScheduler.Enqueue(new MavenErrorRetryProcess(configuration, elasticPool))
