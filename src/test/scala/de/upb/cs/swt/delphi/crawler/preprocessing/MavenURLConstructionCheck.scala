...
class MavenURLConstructionCheck extends FlatSpec with Matchers {
  ...
  "Irregular identifiers" should "create escaped urls" in {
    val reg1 = MavenIdentifier("http://repo1.maven.org/maven2/", "net.java.dev.jogl", "jogl", "${parent.version}")
    val reg2 = MavenIdentifier("http://repo1.maven.org/maven2/", "com.sun.corba", "glassfish-corba-orbgeneric","${release.version}-${build.version}")

    reg1.toJarLocation.toASCIIString shouldBe "http://repo1.maven.org/maven2/net/java/dev/jogl/jogl/%24%7Bparent.version%7D/jogl-%24%7Bparent.version%7D.jar"
    reg2.toJarLocation.toASCIIString shouldBe "http://repo1.maven.org/maven2/com/sun/corba/glassfish-corba-orbgeneric/%24%7Brelease.version%7D-%24%7Bbuild.version%7D/glassfish-corba-orbgeneric-%24%7Brelease.version%7D-%24%7Bbuild.version%7D.jar"

    reg1.toPomLocation.toASCIIString shouldBe "http://repo1.maven.org/maven2/net/java/dev/jogl/jogl/%24%7Bparent.version%7D/jogl-%24%7Bparent.version%7D.pom"
    reg2.toPomLocation.toASCIIString shouldBe "http://repo1.maven.org/maven2/com/sun/corba/glassfish-corba-orbgeneric/%24%7Brelease.version%7D-%24%7Bbuild.version%7D/glassfish-corba-orbgeneric-%24%7Brelease.version%7D-%24%7Bbuild.version%7D.pom"
  }
